                ...
                <div class="box">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table class="table table-hover tablesorter table-bordered">
                                        ...
                                        <tbody>
                                        <?php $invoice_total = 0; ?>
                                        @if( count(Cart::instance('transfer')->content()) > 0 )
                                            <?php $i = 1; ?>
                                            @foreach( Cart::instance('transfer')->content() as $cartItem )
                                            <tr>
                                                <td> <?php echo $i++; ?></td>
                                               @if( $cartItem->name == 'product_name' ) 
                                                ...
                                                <td>
                                                    {!! Form::open(['method' => 'DELETE', 'style' => 'display:inline;', 'route' => ['transfer.destroy', $cartItem->rowId ]] ) !!}
                                        ...
                                        @else
                                            <div class="alert alert-danger alert-dismissible">
                                                ...
                                                <strong> No Transfer Schedule !! </strong>
                                            </div>
                                        @endif
                                        </tbody>
                                    </table>
                    ...
                    <div class="box-footer">
                        ...
                        <form method="post" target="_blank" action="{{ route('invoice.store') }}" style="display:inline;">
                          ...
                          <input name="invoice_status" type="hidden" value="transfer">
                          <div class="input-prepend">
                            <span class="add-on"> <i class="icon-envel"> Transfer To &nbsp; </i></span>
                            {!! Form::select('customer_id', App\Customer::pluck('name', 'id'), '', ['placeholder' => 'Select Receiver', 'id' => 'customerId', 'required' => 'true' ]) !!}
                          </div>
                          <div>
                          <!-- Button trigger modal -->
                        ...
                        <form method="post" action="{{ route('transfer.empty') }}" style="display:inline;">
                          @csrf
